...
HD_PWD='/home/wings/OneDrive/Labs/DigitalCircuitLabs/lab3/DigitalCircuit_Lab3/DigitalCircuit_Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_3_divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_3_divider.tcl -notrace
